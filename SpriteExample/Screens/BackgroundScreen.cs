...
namespace WrongHole.Screens
{
    ...
    public class BackgroundScreen : GameScreen
    {
        ...
        public override void Activate()
        {
            ...
            holes[0].LoadContent(GraphicsDevice, _content, "hole2", new Vector2(490, 240));
            holes[0].dummy = false;
            ...
            bangersSmall = _content.Load<SpriteFont>("bangers1");
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            {
                if (playerBall.Bounds.CollidesWith(hole.Bounds) && !hole.dummy) { ExitScreen(); }
            }
